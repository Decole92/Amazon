  ...
  return (
    <div>
      ...
      <div className="bg-white">
        <span className="flex space-x-4 px-5 pt-4 items-center">
          <h2 className="text-lg font-semibold">More items to consider</h2>
          <p className=" cursor-pointer hover:text-red-400 text-sm font-semibold text-cyan-600">
            See more
          </p>
        </span>
